...
namespace bbt.gateway.common.Repositories
{
    public class PhoneConfigurationRepository : Repository<PhoneConfiguration>, IPhoneConfigurationRepository
    {
        ...
        {
            return await Context.PhoneConfigurations.AsNoTracking().Where(i =>
        ...
        {
            return await Context.PhoneConfigurations.AsNoTracking().Where(c => c.Phone.CountryCode == countryCode && c.Phone.Prefix == prefix && c.Phone.Number == number)

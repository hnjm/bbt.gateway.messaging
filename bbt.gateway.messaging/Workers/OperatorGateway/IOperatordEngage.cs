...
namespace bbt.gateway.messaging.Workers.OperatorGateway
{
    public interface IOperatordEngage : IOperatorGatewayBase
    {
        ...
        public Task<PushNotificationResponseLog> SendPush(string contactId, string template, string templateParams, string customParameters, common.Models.v2.InboxParams? inboxParams, string[] tags);
